...
| -------------- | -------------------------- | ------------ |
| API名          | サービス契約               | -            |
| エンドポイント | `/api/v1/contracts/create` | -            |
| メソッド       | `POST`                     | リソース作成 |
| 系統           | 登録                       | -            |
| 認証要否       | 必要                       | -            |
| データ形式     | JSON                       | -            |
...
| ---------- | --------- | ------ | ---------- | ---------- | ---- | -------- | -------- | ------------ | ------ | :----- | :------------------------------- |
| ユーザーID | userId    | string | 契約       | ユーザーID | 必須 | 36       | 36       | UUID         | -      | -      | 契約するユーザーのID             |
| サービスID | serviceId | string | 契約       | サービスID | 必須 | 36       | 63       | UUID         | -      | -      | 契約対象のサービスID             |
| 契約数     | quantity  | number | 契約       | 契約数     | 必須 | -        | -        | -            | 1      | 99     | 契約ユニット数(例: ライセンス数) |
